...
Public Class APIManager
    ...
    Public Sub Query(Form1 As Main, useDefaultImage As Boolean, snapshotName As String, defaultImage As String)
        Dim thread As New System.Threading.Thread(Sub() asyncQuery(Form1, useDefaultImage, snapshotName, defaultImage))
        thread.Start()
    End Sub

    Private Sub asyncQuery(Form1 As Main, useDefaultImage As Boolean, snapshotName As String, defaultImage As String)
